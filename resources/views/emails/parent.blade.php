...
<ul>
    @if($registration->location === 'aldenham')
        ...
        <li><b>Ramadan:</b> As camp is falling during the holy mot h of Ramadan, food and drink will only be allowed in the cafeteria and that any children fasting will be separated during breaks.</li>
...
<p>If you need to reach us, please contact: [contact details to be inserted here]</p>
</body>
